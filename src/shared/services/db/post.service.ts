...
import { IGetPostsQuery, IPostDocument, IQueryComplete, IQueryDeleted } from 'src/features/posts/interfaces/post.interface';
import { PostModel } from 'src/features/posts/models/post.schema';
